...
<body>
    <header class="bg-primary">
        ...
        <nav class="bg-white border-top py-3 border-3 border-dark d-flex">
            ...
            <p class="fs-4 ms-3"> / </p>
            <a class="fs-4 nav-a mx-3 text-decoration-none actual" href="/administrador/añadirMedicos/">Añadir Médicos</a>
        </nav>
    </header>
    ...
    <main>
        <form method="POST" action="">
            <fieldset class="mb-5 container-fluid mx-auto">
                <legend class="fs-3">Datos del Médico</legend>
                <div class="d-flex flex-column flex-sm-column flex-md-column flex-lg-row flex-xl-row flex-xxl-row gap-3">
                    <div class="col mt-2">
                        <label class="row fs-5 mb-2" for="nombre">Nombre: </label>
                        <input type="text" placeholder="Escriba su nombre" class="row form-control" id="nombre">
                    </div>
    
                    <div class="col mt-2">
                        <label class="row fs-5 mb-2" for="apellido">Apellido: </label>
                        <input type="text" placeholder="Escriba su apellido" class="row form-control" id="apellido">
                    </div>
    
                    <div class="col mt-2">
                        <label class="row fs-5 mb-2" for="nombre">Cédula: </label>
                        <input type="text" placeholder="Ej: 00-0000-0000" class="row form-control" id="nombre">
                    </div>
                </div>
            </fieldset>

            <fieldset  class="mb-5 container-fluid mx-auto">
                <legend class="fs-3">Datos laborales</legend>
                <!--Aqui se coloca un foreach de la respuesta de la base de datos lo que creará el checkbox n cantidad de datos-->
                <div class="d-flex flex-column flex-sm-column flex-md-column flex-lg-row flex-xl-row flex-xxl-row gap-3">
                    <div class="col mt-2">
                        <label class="row fs-5 mb-2" for="especialidad">Especialidad del Médico</label>
                        <select class="row form-control" name="" id="especialidad">
                            <option value="" hidden>--Seleccione--</option>
                        </select>
                    </div>
    
                    <div class="col mt-2">
                        <label class="row fs-5 mb-2" for="clinica">Clinica donde Trabaja</label>
                        <select class="row form-control" name="" id="clinica">
                            <option value="" hidden>--Seleccione--</option>
                        </select>
                    </div>
                </div>
