...
<body>
    <header class="bg-primary">
        ...
        <nav class="bg-white border-top py-3 border-3 border-dark d-flex">
            ...
            <p class="fs-4 ms-3"> / </p>
            <a class="fs-4 nav-a mx-3 text-decoration-none actual" href="/administrador/añadirClinicas/">Añadir Clinicas</a>
        </nav>
    </header>
    ...
    <main>
        <form method="POST" action="">
            <fieldset class="mb-5 container-fluid mx-auto">
                <legend class="fs-3">Datos de la Clinica</legend>

                <div class="d-flex flex-column flex-sm-column flex-md-column flex-lg-row flex-xl-row flex-xxl-row gap-3">
                    <div class="col mt-2">
                        <label class="row fs-5 mb-2" for="nombre">Nombre de la Clinica: </label>
                        <input class="row form-control" placeholder="Escriba el nombre de la clinica" type="text" class="" id="nombre">
                    </div>

                     <div class="col mt-2">
                        <label class="row fs-5 mb-2" for="direccion">Dirección: </label>
                        <input class="row form-control" placeholder="Escriba la dirección Ej: Provincia, Distrito, Corregimiento, Calle" type="text" class="" id="direccion">
                    </div>
                </div>
            </fieldset>

            <fieldset class="mb-5 container-fluid mx-auto">
                <legend>Especialidades para la Clinica</legend>
    ...
    <footer class="text-center mt-5 align-bottom">
